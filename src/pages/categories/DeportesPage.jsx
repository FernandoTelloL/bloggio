...
export const DeportesPage = () => {
  const [categoryDeportes, setCategoryDeportes] = useState([])
  ...
  return (
    <>
      ...
      <section>
        <h2 className='text-3xl font-bold lg:mt-16 mb-12'>Listado de Posts de categoria DEPORTES</h2>
        <div className='md:grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8 lg:mb-16'>
          {categoryDeportes.length > 0
            ? (
                categoryDeportes.map((viaje) => (
