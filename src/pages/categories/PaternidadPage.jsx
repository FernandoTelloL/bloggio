...
export const PaternidadPage = () => {
  ...
  const fetchData = async (filters) => {
    ...
    try {
      ...
      setCategoryPaternidad(data)
    } catch (error) {
      console.error('Error al hacer el fetch:', error)
      setCategoryPaternidad([])
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <>
      ...
      <section>
        <h2 className='text-3xl font-bold lg:mt-16 mb-12'>Listado de Posts de categoria PATERNIDAD</h2>
